...
while recording_active:
    ...
    passport_image_placeholder.image("passport_image.jpg", caption="Passport Image", use_column_width=True)
    ...
    plt.close(fig)
    graph_placeholder.image(graph_path, caption="Detection Summary Graph", use_column_width=True)
